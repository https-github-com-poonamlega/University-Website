...
namespace websitee.Controllers
{
    public class Events_User_RelationController : Controller
    {
        ...
        {
            var events_User_Relation = db.Events_User_Relation.Include(e => e.Event);
            return View(events_User_Relation.ToList());
        }
        ...
        public ActionResult Details(int? id)
        {
            ...
            Events_User_Relation events_User_Relation = db.Events_User_Relation.Find(id);
        ...
        public ActionResult Create([Bind(Include = "Id,Event_Id,User_Id,Like_Dislike,Interest,Comment,Attendence")] Events_User_Relation events_User_Relation)
        {
            if (ModelState.IsValid)
            {
                db.Events_User_Relation.Add(events_User_Relation);
                db.SaveChanges();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Event_Id,User_Id,Like_Dislike,Interest,Comment,Attendence")] Events_User_Relation events_User_Relation)
        {
            if (ModelState.IsValid)
            {
        ...
        {
            Events_User_Relation events_User_Relation = db.Events_User_Relation.Find(id);
            db.Events_User_Relation.Remove(events_User_Relation);
            db.SaveChanges();
            return RedirectToAction("Index");
        }
